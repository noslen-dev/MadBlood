...
public class LoginController implements Initializable {
    ...
    public void registerHandlers(){
        ...
        Platform.runLater(()->{ idUsernameField.requestFocus();});
    }
    ...
    public void changeToAdministrative() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("../resources/fxml/administrative_base_layout.fxml"));
        AdministrativeController administrative_controller = new AdministrativeController(model);
        loader.setController(administrative_controller);
        Parent root = loader.load();
